      ...
      <div style={innerContainerStyle}>
        ...
        <div style={headerSectionStyle}>
          ...
          <div style={titleContainerStyle}>
            ...
            <p style={subtitleStyle}>
              Manage and track customer inquiries, monitor response times, and maintain excellent customer service
            </p>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={statsSectionStyle}>
            <div style={{
              ...decorativePatternStyle,
              background: `radial-gradient(circle, ${theme.colors.secondary}05 0%, transparent 70%)`,
            }} />
            <div style={sectionHeaderStyle}>
              <h2 style={sectionTitleStyle}>
                <FiBarChart2 size={24} />
