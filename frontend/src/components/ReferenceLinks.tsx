...
import type { ReferenceLinks as ReferenceLinksType } from '../types/types';

interface ReferenceLinksProps {
  references: ReferenceLinksType;
}
...
const ReferenceLinks: React.FC<ReferenceLinksProps> = ({ references }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
      <h3 className="text-lg font-bold text-gray-800 mb-4">Find Us On</h3>
      <div className="flex flex-wrap gap-4">
        {references.facebook && (
          <a 
            href={references.facebook} 
            target="_blank" 
