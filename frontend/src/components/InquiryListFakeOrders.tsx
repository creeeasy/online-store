...
import { useFakeOrderInquiries } from '../hooks/useOrderInquiry';
...
const InquiryListFakeOrders: React.FC = () => {
  ...
  const { data, isLoading, error, refetch, isFetching } = useFakeOrderInquiries(filters);
  console.log(data)
      ...
      <div style={innerContainerStyle}>
        <div style={headerStyle}>
          <div style={titleContainerStyle}>
            <div>
              <h2 style={titleStyle}>Fake Orders</h2>
...
export default InquiryListFakeOrders;